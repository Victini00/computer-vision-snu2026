...
def create_bones(part_scores, joint_pairs, node_proposals, viz_thrs=0.05, max_per_bone=200):
...
def create_bone_mesh(A, B, radius=0.01, sections=6):
    """
